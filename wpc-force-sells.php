...
! defined( 'WOOFS_VERSION' ) && define( 'WOOFS_VERSION', '6.2.0' );
			...
			class WPCleverWoofs {
				...
				function admin_menu_content() {
                    ...
                    <div class="wpclever_settings_page wrap">
                        <h1 class="wpclever_settings_page_title"><?php echo esc_html__( 'WPC Force Sells', 'wpc-force-sells' ) . ' ' . esc_html( WOOFS_VERSION ) . ' ' . ( defined( 'WOOFS_PREMIUM' ) ? '<span class="premium" style="display: none">' . esc_html__( 'Premium', 'wpc-force-sells' ) . '</span>' : '' ); ?></h1>
                        <div class="wpclever_settings_page_desc about-text">
                            <p>
								<?php printf( /* translators: stars */ esc_html__( 'Thank you for using our plugin! If you are satisfied, please reward it a full five-star %s rating.', 'wpc-force-sells' ), '<span style="color:#ffb900">&#9733;&#9733;&#9733;&#9733;&#9733;</span>' ); ?>
                                <br/>
                        ...
                        <div class="wpclever_settings_page_nav">
                            <h2 class="nav-tab-wrapper">
                                <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-woofs&tab=how' ) ); ?>" class="<?php echo esc_attr( $active_tab === 'how' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
									<?php esc_html_e( 'How to use?', 'wpc-force-sells' ); ?>
                                </a>
                                <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-woofs&tab=settings' ) ); ?>" class="<?php echo esc_attr( $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
									<?php esc_html_e( 'Settings', 'wpc-force-sells' ); ?>
                                </a>
                                <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-woofs&tab=localization' ) ); ?>" class="<?php echo esc_attr( $active_tab === 'localization' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
									<?php esc_html_e( 'Localization', 'wpc-force-sells' ); ?>
                                </a>
                                <a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-woofs&tab=premium' ) ); ?>" class="<?php echo esc_attr( $active_tab === 'premium' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>" style="color: #c9356e;">
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[position]">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[layout]">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[show_thumb]">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[show_price]">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[show_description]">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[link]">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[variations_selector]">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[exclude_unpurchasable]">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[cart_contents_count]">
                                        ...
                                        <tr class="show_if_section_none">
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[hide_linked_mini_cart]">
                                        ...
                                        <tr class="show_if_section_none">
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[hide_linked]">
                                        ...
                                        <tr class="show_if_section_none">
                                            ...
                                            <td>
                                                <label> <select name="woofs_settings[hide_linked_order]">
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input type="text" class="regular-text" name="woofs_localization[linked]" value="<?php echo esc_attr( self::localization( 'linked' ) ); ?>" placeholder="<?php /* translators: product name */
													esc_attr_e( '(linked to %s)', 'wpc-force-sells' ); ?>"/> </label>
                                                <span class="description"><?php /* translators: product name */
													esc_html_e( 'The text behind force sells products. Use "%s" for the main product name.', 'wpc-force-sells' ); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <label>
                                                    <input type="text" class="regular-text" name="woofs_localization[choose]" value="<?php echo esc_attr( self::localization( 'choose' ) ); ?>" placeholder="<?php /* translators: attribute name */
													esc_attr_e( 'Choose %s', 'wpc-force-sells' ); ?>"/> </label>
                                                <span class="description"><?php /* translators: attribute name */
													esc_html_e( 'Use %s to show the attribute name.', 'wpc-force-sells' ); ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th><?php /* translators: product name */
												esc_html_e( 'Linked products: %s', 'wpc-force-sells' ); ?></th>
                                            <td>
                                                <label>
                                                    <input type="text" class="regular-text" name="woofs_localization[linked_products_s]" value="<?php echo esc_attr( self::localization( 'linked_products_s' ) ); ?>" placeholder="<?php /* translators: product name */
													esc_attr_e( 'Linked products: %s', 'wpc-force-sells' ); ?>"/>
                                                </label>
                                            </td>
                                        </tr>
                                        <tr class="heading">
				...
				function search_settings() {
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input class="woofs_search_limit" type="number" name="woofs_settings[search_limit]" value="<?php echo esc_attr( self::get_setting( 'search_limit', 10 ) ); ?>"/>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <label> <select name="woofs_settings[search_sku]" class="woofs_search_sku">
                    ...
                    <tr>
                        ...
                        <td>
                            <label> <select name="woofs_settings[search_id]" class="woofs_search_id">
                    ...
                    <tr>
                        ...
                        <td>
                            <label> <select name="woofs_settings[search_exact]" class="woofs_search_exact">
                    ...
                    <tr>
                        ...
                        <td>
                            <label> <select name="woofs_settings[search_sentence]" class="woofs_search_sentence">
                    ...
                    <tr>
                        ...
                        <td>
                            <label> <select name="woofs_settings[search_same]" class="woofs_search_same">
				...
				function action_links( $links, $file ) {
					...
					if ( $plugin === $file ) {
						$settings             = '<a href="' . esc_url( admin_url( 'admin.php?page=wpclever-woofs&tab=settings' ) ) . '">' . esc_html__( 'Settings', 'wpc-force-sells' ) . '</a>';
						$links['wpc-premium'] = '<a href="' . esc_url( admin_url( 'admin.php?page=wpclever-woofs&tab=premium' ) ) . '">' . esc_html__( 'Premium Version', 'wpc-force-sells' ) . '</a>';
				...
				function cart_item_name( $name, $item ) {
					if ( ! empty( $item['woofs_parent_id'] ) ) {
						$linked_text = self::localization( 'linked', /* translators: product name */ esc_html__( '(linked to %s)', 'wpc-force-sells' ) );

						if ( str_contains( $name, '</a>' ) ) {
							$parent_name = sprintf( $linked_text, '<a href="' . esc_url( get_permalink( $item['woofs_parent_id'] ) ) . '">' . esc_html( get_the_title( $item['woofs_parent_id'] ) ) . '</a>' );
						} else {
							$parent_name = sprintf( $linked_text, esc_html( get_the_title( $item['woofs_parent_id'] ) ) );
						}
							...
							foreach ( $items as $key => $item ) {
								...
								if ( $item['id'] ) {
									...
									if ( $item_product->is_type( 'variable' ) ) {
										wc_add_notice( sprintf( /* translators: product name */ esc_html__( '"%s" is un-purchasable.', 'wpc-force-sells' ), esc_html( $item_product->get_name() ) ), 'error' );
										wc_add_notice( esc_html__( 'You cannot add this product to the cart.', 'wpc-force-sells' ), 'error' );
				...
				function before_order_itemmeta( $order_item_id, $order_item ) {
					if ( $ids = $order_item->get_meta( '_woofs_ids' ) ) {
						...
						if ( is_array( $items ) && ! empty( $items ) ) {
							...
							foreach ( $items as $item ) {
								...
								$items_arr[] = apply_filters( 'woofs_admin_order_linked_product_name', '<li>' . $item['qty'] . ' × ' . esc_html( get_the_title( $item['id'] ) ) . '</li>', $item );
							}

							$items_str = apply_filters( 'woofs_admin_order_linked_product_names', '<ul>' . implode( '', $items_arr ) . '</ul>', $items );

							echo apply_filters( 'woofs_before_order_itemmeta', '<div class="woofs-itemmeta-linked">' . sprintf( self::localization( 'linked_products_s', /* translators: product name */ esc_html__( 'Linked products: %s', 'wpc-force-sells' ) ), $items_str ) . '</div>', $order_item_id, $order_item );
						}
					}
					...
					if ( $parent_id = $order_item->get_meta( '_woofs_parent_id' ) ) {
						...
						echo sprintf( $linked_text, esc_html( get_the_title( $parent_id ) ) );
					}
				}
						...
						if ( is_array( $items ) && ! empty( $items ) ) {
							if ( self::get_setting( 'hide_linked_order', 'no' ) === 'yes_list' ) {
								...
								foreach ( $items as $item ) {
									...
									$items_arr[] = apply_filters( 'woofs_order_linked_product_name', '<li>' . $item['qty'] . ' × ' . esc_html( get_the_title( $item['id'] ) ) . '</li>', $item );
								}
								...
								foreach ( $items as $item ) {
									...
									$items_arr[] = apply_filters( 'woofs_order_linked_product_name', $item['qty'] . ' × ' . esc_html( get_the_title( $item['id'] ) ), $item );
								}

								$items_str = apply_filters( 'woofs_order_linked_product_names', implode( '; ', $items_arr ), $items );
							}

							echo apply_filters( 'woofs_order_item_meta_start', '<div class="woofs-itemmeta-linked">' . sprintf( self::localization( 'linked_products_s', /* translators: product name */ esc_html__( 'Linked products: %s', 'wpc-force-sells' ) ), $items_str ) . '</div>', $order_item_id, $order_item );
						}
					}
				}
					...
					if ( is_array( $items ) && ! empty( $items ) ) {
						if ( self::get_setting( 'hide_linked', 'no' ) === 'yes_list' ) {
							...
							foreach ( $items as $item ) {
								...
								$items_str[] = apply_filters( 'woofs_order_linked_product_name', '<li>' . $item['qty'] . ' × ' . esc_html( get_the_title( $item['id'] ) ) . '</li>', $item );
							}
							...
							foreach ( $items as $item ) {
								...
								$items_str[] = apply_filters( 'woofs_order_linked_product_name', $item['qty'] . ' × ' . esc_html( get_the_title( $item['id'] ) ), $item );
							}
				...
				function display_post_states( $states, $post ) {
					if ( 'product' == get_post_type( $post->ID ) ) {
						if ( ( $items = self::get_product_items( $post->ID, 'edit' ) ) && ! empty( $items ) ) {
							...
							if ( $count ) {
								$states[] = apply_filters( 'woofs_post_states', '<span class="woofs-state">' . sprintf( /* translators: count */ esc_html__( 'Force sells (%d)', 'wpc-force-sells' ), $count ) . '</span>', $count, $post->ID );
							}
						}
					}
				...
				function ajax_get_search_results() {
					...
					if ( ( self::get_setting( 'search_id', 'no' ) === 'yes' ) && is_numeric( $keyword ) ) {
						...
						$limit = self::get_setting( 'search_limit', 10 );
					...
					if ( $query->have_posts() ) {
						...
						echo '<ul><span>' . sprintf( /* translators: keyword */ esc_html__( 'No results found for "%s"', 'wpc-force-sells' ), esc_html( $keyword ) ) . '</span></ul>';
					}
				...
				function product_data_li( $product, $price = '100%', $qty = 1, $search = false, $key = null ) {
					...
					$hidden_input  = '<input type="hidden" name="' . esc_attr( 'woofs_ids[' . $key . '][id]' ) . '" value="' . $product_id . '"/><input type="hidden" name="' . esc_attr( 'woofs_ids[' . $key . '][sku]' ) . '" value="' . $product_sku . '"/>';
					$product_image = '<span class="img">' . $product->get_image( [ 30, 30 ] ) . '</span>';

					echo '<li class="' . esc_attr( trim( $product_class ) ) . '" data-id="' . $product->get_id() . '">' . $hidden_input . '<span class="woofs-move"></span><span class="price hint--right" aria-label="' . esc_html__( 'Set a new price using a number (eg. "49") or percentage (eg. "90%" of original price)', 'wpc-force-sells' ) . '"><input name="' . esc_attr( 'woofs_ids[' . $key . '][price]' ) . '" type="text" value="' . $price . '"/></span><span class="qty hint--right" aria-label="' . esc_html__( 'Quantity', 'wpc-force-sells' ) . '"><input name="' . esc_attr( 'woofs_ids[' . $key . '][qty]' ) . '" type="number" value="' . $qty . '" min="' . $step . '" step="' . $step . '"/></span>' . $product_image . '<span class="data">' . esc_html( $product->get_name() ) . ' (' . $product->get_price_html() . ')</span> <span class="type"><a href="' . esc_url( get_edit_post_link( $product_id ) ) . '" target="_blank">' . $product->get_type() . '<br/>#' . $product->get_id() . '</a></span> ' . $remove_btn . '</li>';
				}
				...
				function product_data_panels() {
                    ...
                    <div id='woofs_settings' class='panel woocommerce_options_panel woofs_table'>
                        ...
                        <table>
                            <tr>
                                <th><?php esc_html_e( 'Search', 'wpc-force-sells' ); ?> (<a href="<?php echo esc_url( admin_url( 'admin.php?page=wpclever-woofs&tab=settings#search' ) ); ?>" id="woofs_search_settings_btn"><?php esc_html_e( 'settings', 'wpc-force-sells' ); ?></a>)
                                </th>
                                <td>
                                    <div class="w100">
                                        <span class="loading" id="woofs_loading" style="display:none;"><?php esc_html_e( 'searching...', 'wpc-force-sells' ); ?></span>
                                        <label for="woofs_keyword"></label><input type="search" id="woofs_keyword" placeholder="<?php esc_html_e( 'Type any keyword to search', 'wpc-force-sells' ); ?>"/>
                            ...
                            <tr class="woofs_tr_space">
                                <th></th>
                                <td>
                                    <a href="https://wpclever.net/downloads/force-sells?utm_source=pro&utm_medium=woofs&utm_campaign=wporg" target="_blank" class="woofs_add_txt button" onclick="return confirm('This feature only available in Premium Version!\nBuy it now? Just $29')">
                            ...
                            <tr class="woofs_tr_space">
                                ...
                                <td>
                                    <label for="woofs_sync_quantity"></label><input id="woofs_sync_quantity" name="woofs_sync_quantity" type="checkbox" <?php echo esc_attr( get_post_meta( $product_id, 'woofs_sync_quantity', true ) !== 'off' ? 'checked' : '' ); ?>/>
                            ...
                            <tr class="woofs_tr_space">
                                ...
                                <td>
                                    <label for="woofs_separately"></label><input id="woofs_separately" name="woofs_separately" type="checkbox" <?php echo esc_attr( get_post_meta( $product_id, 'woofs_separately', true ) === 'on' ? 'checked' : '' ); ?>/>
                            ...
                            <tr class="woofs_tr_space">
                                ...
                                <td>
                                    ...
                                    <label> <select name="woofs_layout">
                            ...
                            <tr class="woofs_tr_space">
                                ...
                                <td>
                                    <div class="w100">
                                        <label>
                                            <textarea name="woofs_before_text" rows="1" style="width: 100%"><?php echo esc_textarea( get_post_meta( $product_id, 'woofs_before_text', true ) ); ?></textarea>
                                        </label>
                                    </div>
                                </td>
                            </tr>
                            <tr class="woofs_tr_space">
                                ...
                                <td>
                                    <div class="w100">
                                        <label>
                                            <textarea name="woofs_after_text" rows="1" style="width: 100%"><?php echo esc_textarea( get_post_meta( $product_id, 'woofs_after_text', true ) ); ?></textarea>
                                        </label>
                                    </div>
                                </td>
                            </tr>
				...
				function process_product_meta( $post_id ) {
					...
					if ( isset( $_POST['woofs_layout'] ) ) {
						update_post_meta( $post_id, 'woofs_layout', sanitize_text_field( $_POST['woofs_layout'] ) );
					}

					if ( isset( $_POST['woofs_before_text'] ) ) {
						update_post_meta( $post_id, 'woofs_before_text', sanitize_post_field( 'post_content', $_POST['woofs_before_text'], $post_id, 'display' ) );
					}

					if ( isset( $_POST['woofs_after_text'] ) ) {
						update_post_meta( $post_id, 'woofs_after_text', sanitize_post_field( 'post_content', $_POST['woofs_after_text'], $post_id, 'display' ) );
					}
				}
				...
				function show_items() {
					...
					if ( ! empty( $items ) && is_array( $items ) ) {
						...
						if ( $before_text = apply_filters( 'woofs_before_text', get_post_meta( $product_id, 'woofs_before_text', true ) ?: self::localization( 'above_text' ), $product_id ) ) {
							echo '<div class="woofs-before-text woofs-text">' . wp_kses_post( do_shortcode( $before_text ) ) . '</div>';
						}
                                    ...
                                    <div class="<?php echo esc_attr( apply_filters( 'woobt_item_class', $item_class, $item ) ); ?>" data-key="<?php echo esc_attr( $item_key ); ?>" data-name="<?php echo esc_attr( $product->get_name() ); ?>" data-id="<?php echo esc_attr( $item_data_id ); ?>" data-price="<?php echo esc_attr( apply_filters( 'woofs_item_new_price', $item_data_price, $item, $product ) ); ?>" data-price-ori="<?php echo esc_attr( apply_filters( 'woofs_item_price', wc_get_price_to_display( $product ), $item, $product ) ); ?>" data-regular-price="<?php echo esc_attr( apply_filters( 'woofs_item_regular_price', wc_get_price_to_display( $product, [ 'price' => $product->get_regular_price() ] ), $item, $product ) ); ?>" data-qty="<?php echo esc_attr( $item_qty ); ?>" data-qty-ori="<?php echo esc_attr( $item_qty ); ?>" data-order="<?php echo esc_attr( $order ); ?>">
                                        ...
                                        <div class="woofs-title">
											...
											if ( self::get_setting( 'show_description', 'no' ) === 'yes' ) {
												echo '<div class="woofs-description">' . wp_kses_post( $product->is_type( 'variation' ) ? $product->get_description() : $product->get_short_description() ) . '</div>';
											}

											echo '<div class="woofs-availability">' . wp_kses_post( wc_get_stock_html( $product ) ) . '</div>';
						...
						if ( $after_text = apply_filters( 'woofs_after_text', get_post_meta( $product_id, 'woofs_after_text', true ) ?: self::localization( 'under_text' ), $product_id ) ) {
							echo '<div class="woofs-after-text woofs-text">' . wp_kses_post( do_shortcode( $after_text ) ) . '</div>';
						}
					...
					if ( ! empty( $ids ) ) {
						...
						if ( is_array( $_items ) && count( $_items ) > 0 ) {
							foreach ( $_items as $_item ) {
								...
								$_item_key     = $_item_data[0] ?? self::generate_key();
								$_item_id      = apply_filters( 'woofs_item_id', absint( $_item_data[1] ?? 0 ), $_item, $product_id );
				...
				function product_filter_callback() {
					$woofs  = wc_clean( wp_unslash( $_REQUEST['woofs'] ?? '' ) );
